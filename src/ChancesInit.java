 ...
 * @author Nathan Shen, Carol Chen, Nicholas Carr
 */
import javax.swing.*;
...
//Variables
  ...
  //executes code on chance cards
  public interface ChanceAction {
    String execute();
  }
  
  // Create array of chance cards //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  // creates array of wild chance cards //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  // Creates instance of game in this method
  ...
  // Individual chance and wild chance cards  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  public static String backwards() { // wild chance
    ...
    return "you are going backwards now";
     ...
     public static String freePassGo() { // chance
    Player currPlayer = players[game.getCurrPlayer()];
    currPlayer.earnCurrency("MIL", 200);
    return "you pass go!";
  }
     
     
       public static String unPassGo() { // chance
    Player currPlayer = players[game.getCurrPlayer()];
    currPlayer.spendCurrency("MIL", 200);
    return "you unpass go! \n you loose 200M";
  }
       
       
         public static String commie() { // wild chance
    Player currPlayer = players[game.getCurrPlayer()];
   
   //message("HAHAHA Version2","Everyone is dead");
   while(true){
   JOptionPane.showMessageDialog(null, "you are dead, everyone is dead");
   }
