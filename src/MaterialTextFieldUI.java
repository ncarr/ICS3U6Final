...
public class MaterialTextFieldUI extends BasicTextFieldUI implements FocusListener {
	...
	public void installUI (JComponent c) {
		...
		this.unfocusedBackground = MaterialLookAndFeel.LIGHT_GRAY;

		this.focusedSelectedBackground = MaterialLookAndFeel.bleach (focusedBackground, 0.3f);
